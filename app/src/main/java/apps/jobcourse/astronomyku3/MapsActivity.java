...
import apps.jobcourse.astronomyku3.databinding.ActivityMapsBinding;
...
public class MapsActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng nasa = new LatLng(38.895112, -77.036366);
        mMap.addMarker(new MarkerOptions().position(nasa).title("Marker in NASA HQ"));
        mMap.moveCamera(CameraUpdateFactory.newLatLng(nasa));
